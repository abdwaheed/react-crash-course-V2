        ...
        <div class="dashboard-menu">
          <div class="container">
            <div class="col-md-9 offset-md-3">
              <ul>
                <li style={{ backgroundColor: location.pathname != '/teacherprofile' && location.pathname != '/teacherintendedlearners' && location.pathname != '/teacheruploadlecture' && location.pathname != '/teachercourselanding' && location.pathname != '/teachereditlecture' ? 'rgb(66, 112, 143)' : '' }}>
                ...
                <li style={{
                  backgroundColor: location.pathname === '/teacherintendedlearners'
                    || location.pathname === '/teacheruploadlecture' || location.pathname === '/teachereditlecture' ? 'rgb(66, 112, 143)' : ''
                }}>
